...
Мама:
Рассчитали объем одной установки 2.22*0.7*

Объем помещения разделили на объем одной установки

Между установками должен быть проход 2 метра

Ширина одной установки 0.7. значит нужно убрать 3 установки что бы был проход

Площадь помещения 600:(0.7*3).

Из общего количества установок нужно вычесть 285 штук

И тогда получатся установки с проходами 2 м между ними

Объем одной установки 2.22*0.7*2.5=3.8 м3

Объем помещения 2100м3:3.8=552 установки если без проходов.
...
Надо 600:(2.22*0.7*3)=386

552-386=166. А как 89 получили не помню
